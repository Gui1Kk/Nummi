...
export const recurringInput = z.object({
  ...
  anchor_day: z.number().int().min(1).max(31), start_date: isoDate, next_date: isoDate,
  end_date: isoDate.nullable().optional(), auto_post: z.boolean().default(true),
  active: z.boolean().default(true), note: optionalNote
}).strict();
...
export const subscriptionInput = z.object({
  ...
  end_date: isoDate.nullable().optional(), active: z.boolean().default(true),
